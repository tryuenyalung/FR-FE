<template>
    <div>
        ...
        <div class="modal" :class="{'is-active' : this.registrationLoader }" >
                                ...
                                <div class="columns">
                                    ...
                                    <div class="column">
                                        ...
                                        <input  name="dateOfBirth" 
                                                v-model="dateOfBirth"
                                                class="input" 
                                                :class="{ 'is-danger': errors.has('dateOfBirth') }" 
                                                v-validate="'required'" 
                                                type="date" 
                                                placeholder="Street, Barangay, Municipality, Province, City">
        ...
        methods:{
            ...
            validateBeforeSubmit() {
                this.$validator.validateAll().then((res) => {
                    ...
                    this.signatureImage === null ? this.$notify( this.showNotif('warn', 'Warning', 'fa-exclamation-triangle','please fill up the form') ) : null
                })
            }
